...
public */
 class Task {
    ...
    Task(String taskname,int taskNumber,String description,String developerDetails,int taskDuration,String taskID,String taskStatus){
    ...
    Task(String taskname, int i, String description, String developerDetails, int taskDuration) {
